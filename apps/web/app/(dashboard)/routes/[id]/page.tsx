              ...
              {route.vehicle ? (
                <>
                  ...
                  <p>
                    ...
                    {route.vehicle.capacity_kg || "?"} kg
                  </p>
                  {route.vehicle.make_model && (
                    <p>
            ...
            <CardContent>
              <div className="space-y-2">
                  ...
                  {route.total_stops > 0 && (
                    <>
                      <div
                        ...
                        style={{
                          width: `${(deliveredStops / route.total_stops) * 100}%`,
                        }}
                      />
                      <div
                        className="h-full bg-red-500"
                        style={{
                          width: `${(failedStops / route.total_stops) * 100}%`,
                        }}
                      />
                    </>
                  )}
                ...
                <p className="text-xs text-muted-foreground text-center">
                  {route.total_stops > 0
                    ? Math.round(
                        ((deliveredStops + failedStops) / route.total_stops) *
                          100,
                      )
                    : 0}
                  % complete
          ...
          <CardContent>
            <div className="space-y-3">
              {route.stops.map((stop) => (
                <div
                  key={stop.id}
                  className={`flex items-start gap-3 rounded-lg border p-3 ${STOP_STATUS_COLORS[stop.status] || ""}`}
                >
