                ...
                {loading ? (
                  ...
                  <tr>
                    ...
                    >
                      ...
                      <p className="text-xs mt-1">
                        Import orders via CSV or create one manually
                      </p>
                    </td>
                  </tr>
                ) : (
                  orders.map((order) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-medium ${STATUS_COLORS[order.status] || "bg-gray-100"}`}
                        >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-medium ${PRIORITY_COLORS[order.priority] || ""}`}
                        >
                          {order.priority}
                        </span>
                      </td>
