  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const res = await fetch(
        `${apiUrl}/api/v1/analytics/hub/${hId}/dashboard`,
        { headers },
      );
        ...
        {dashboard && (
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              ...
              <StatCard
                label="Failed"
                value={dashboard.orders.failed}
                className="border-red-200"
              />
              <StatCard
                label="Success Rate"
                value={`${dashboard.orders.success_rate}%`}
              />
              <StatCard
              ...
              <StatCard
                label="COD Collected"
                value={`Rs. ${dashboard.orders.cod_collected.toLocaleString()}`}
              />
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <StatCard
                ...
                value={dashboard.orders.out_for_delivery}
              />
              <StatCard
                label="Returned to Hub"
                value={dashboard.orders.returned_to_hub}
              />
            </div>
          </>
        )}
                      ...
                      <div key={row.date} className="flex items-center gap-3">
                        ...
                        <div className="flex-1 flex gap-0.5 h-6">
                          <div
                            ...
                            style={{
                              width: `${(row.delivered / maxTotal) * 100}%`,
                            }}
