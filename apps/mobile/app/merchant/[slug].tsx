...
export default function MerchantScreen() {
  ...
  const { currentMerchant, currentProducts, loading, fetchMerchantBySlug } =
    useMerchantsStore();
  ...
  const handleAddToCart = (product: any) => {
    ...
    if (
      cartMerchant &&
      cartMerchant.id !== currentMerchant.id &&
      cartItemCount > 0
    ) {
      Alert.alert(
        "Replace cart?",
  ...
  const productsByCategory = currentProducts.reduce(
    (acc, product) => {
        ...
        <View style={[styles.infoCard, { backgroundColor: colors.card }]}>
          <View style={styles.infoHeader}>
            <View>
              ...
              <Text
                style={[styles.merchantType, { color: colors.textSecondary }]}
              >
            ...
            {!currentMerchant.is_open && (
              <View
                style={[styles.closedBadge, { backgroundColor: colors.error }]}
              >
          ...
          {currentMerchant.minimum_order > 0 && (
            <Text
              style={[styles.minimumOrder, { color: colors.textSecondary }]}
            >
                  ...
                  >
                    ...
                    <View style={styles.productRight}>
                      ...
                      <TouchableOpacity
                        ...
                        disabled={
                          !product.is_available || !currentMerchant.is_open
                        }
                      >
