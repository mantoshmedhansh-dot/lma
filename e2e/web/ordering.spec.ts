...
test.describe("Ordering Flow", () => {
    ...
    test("should show cart bar after adding item", async ({ page }) => {
      ...
      if (await addButton.isVisible()) {
        ...
        const cartBar = page.locator(
          '[data-testid="cart-bar"], [data-testid="cart-summary"]',
        );
  ...
  test.describe("Checkout", () => {
    test("should display checkout form", async ({ page }) => {
      ...
      await expect(checkoutPage.addressSelector.or(page.getByText(/address/i)))
    ...
    test("should have payment method options", async ({ page }) => {
      ...
      const paymentSection = page.locator(
        '[data-testid="payment-method"], [data-testid="payment-options"]',
      );
  ...
  test.describe("Order Tracking", () => {
    test("should display order status page", async ({ page }) => {
      ...
      const content = page.locator(
        '[data-testid="order-card"], [data-testid="no-orders"]',
      );
